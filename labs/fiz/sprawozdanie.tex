...
\studycycle{Information Technology}
\coursesemester{II}

\coursename{Modern Physics}
\courseyear{2012/2013}

\courseteacher{dr inż. Maciej Dems}
\coursegroup{Group: VI, Thursday, 16:00}
...
\svnurl{http://phys.p.lodz.pl/materialy/mdems/523.pdf}
...
\begin{thebibliography}{2}
    \bibitem[HRW]{HRW}Fundamentals of physics (2011). David Halliday, Robert Resnick, Jearl Walker. 9th ed. ISBN 978-0-470-46908-8
\end{thebibliography}
{\color{blue} 
